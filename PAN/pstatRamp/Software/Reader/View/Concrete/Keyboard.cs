...
namespace IO.View.Concrete
{
    ...
    public partial class Keyboard : Form
    {
        ...
        public bool Password
        {
            ...
            set
            {
                // Set the new value on the text box and refresh it
        ...
        /// Default constructor
        /// </summary>
        public Keyboard(string title, string text)
        {
            InitializeComponent();
        ...
        private void UpdateCase()
        {
            ...
            foreach (var control in pictureBoxBackground.Controls)
            {
                ...
                if (control is Key)
                {
                    ...
                    // Check the key is a valid text character key
                    if ((key.Text.Length == 1) && (VALID_TEXT_CHARACTERS.Contains(key.Text[0])))
                    {
                        // Set the case
                        key.Text = keyShift.Toggled ? key.Text.ToUpper() : key.Text.ToLower();
                        key.Refresh();
                    }
                }
            }
        ...
        private void key_Click(object sender, EventArgs e)
        {
            ...
            textBox.Text += keyShift.Toggled ? key.Text.ToUpper() : key.Text.ToLower();
            textBox.Refresh();
        }
        ...
        /// <summary>
        /// Click event handler for the shift key
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void keyShift_Click(object sender, EventArgs e)
        {
            // Toggle the key and refresh the control
            keyShift.Toggled = !keyShift.Toggled;
            keyShift.Refresh();
